...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/twitter1.jpg", __ASSET__assets_images_twitter1_jpg);
		type.set ("assets/images/twitter1.jpg", AssetType.IMAGE);
...
@:keep @:bind #if display private #end class __ASSET__assets_images_twitter1_jpg extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:image("assets/images/twitter1.jpg") #if display private #end class __ASSET__assets_images_twitter1_jpg extends lime.graphics.Image {}

...
class PlayState extends FlxState
{
	...
	private var thoughtArray:Array<String> = [
		"I like anime a lot", "You know some pop music isn't that bad", "Crunchy peanut butter is alright", "Dogs are pretty alright",
		"Children are cool as hell", "Cats are cool", "Water is really better than soda", "La La Land was a good movie",
		"Carly Rae Jepsen music is my favourite", "I'm a bit obnoxious online because I'm kinda shy in person", "I envy others success",
		"I often feel under appreciated", "I don't like watching sports", "I love Newgrounds a LOT", "I feel guilty for not appreciating my heritage",
		"Videogames are the best", "I haven't watched anime for a while", "I miss my old home sometimes, even though it sucked",
		"The internet isn't as bad as many claim it is", "insert something political here", "My family is super cool", "Shoutouts to Simpleflips",
		"What kind of music do you like?", "Wait, this game wasn't about racism?", "I spend too much time on Twitter", "Hip hop, man that stuff's my jam!",
		"Hifumi from New Game is best waifu", "I don't really like berries", "High school was kinda alright", "Teens are alright", "Dogs are meh",
